...
class Esendex(object):
        ...
        def to(self, receipts=None):
                ...
                """
                if not isinstance(receipts, list) and not isinstance(receipts, str):
        ...
        def send(self):
                ...
                print((base64.standard_b64encode(str.encode(self.username + ":" + self.password))).decode("utf-8"))

                req = urllib.request.Request(self.messagedispatcher_url)
                req.add_header("Authorization", "Basic " + (base64.standard_b64encode(str.encode(self.username + ":" + self.password))).decode("utf-8"))
                req.data = xml
